...
class TFMarkerDetectorv3(TFObjectDetector):
    def detect(self, image, min_detection_score_mxt = 0.4, min_detection_score_dot = 0.4, label_offset = 1):
        ...
        # Return the image
        return mxt_detected, detected_bboxes_mxt, mxt_selected_scores, dot_detected, detected_bboxes_dot, dot_selected_scores     # ,image